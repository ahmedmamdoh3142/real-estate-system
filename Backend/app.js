...
app.use((req, res, next) => {
    const allowedOrigins = ['http://localhost', 'http://127.0.0.1', 'file://', 'https://abh-properties.com'];
...
// ==================== ملاحظة: خدمة الملفات الثابتة تم نقلها إلى server.js ====================
// (لمنع التعارض مع مسار Nginx، سيتم التعامل مع /uploads من server.js)
